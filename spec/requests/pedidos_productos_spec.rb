...
RSpec.describe "PedidosProductos", type: :request do
  before :each do
    ...
    @negocio_uno.productos << [@producto_uno, @producto_dos]
    ...
    expect(@negocio_uno.productos).to include(@producto_uno, @producto_dos)
  ...
  describe "GET /pedidos/:pedido_id/productos/:id" do
    ...
    context "usuario no administrador autenticado no dueño" do
      it "No le permite la consulta al usuario y devuelve un mensaje de error no dueño" do
