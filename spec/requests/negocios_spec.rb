describe "Negocios API", type: :request do
  ...
  describe "GET /negocios" do
    ...
    context "usuario no autenticado" do
      it "permite la consulta de todos los negocios" do
    ...
    #Aplica para usuarios dueños y no dueños
  ...
  describe "GET /negocios/:id" do
    ...
    before :each do 
      ...
      #@usuario_dos = FactoryGirl.create :usuario_dos
      @tienda_dos = FactoryGirl.create :papeleria
      @usuario_dos.negocios_propios << @tienda_dos
      expect(@usuario_dos.negocios_propios).to include @tienda_dos
    end  

    context "usuario no autenticado" do
      it "permite la consulta de un negocio" do
  ...
  describe "DELETE /negocios/:id" do
    ...
    context "usuario no autenticado" do
      it "no permite eliminar un negocio" do
    ...
    context "usuario no administrador autenticado dueño" do 
      it "permite eliminar un negocio" do 
  ...
  describe "POST /negocios" do
    ...
    context "usuario no autenticado" do
      it "no permite crear un negocio" do
    ...
    context "usuario no administrador autenticado" do
      it "permite crear un negocio" do
        # Login usuario_uno
        @cabeceras_peticion.merge! @usuario_uno.create_new_auth_token
  ...
  #    @usuario_dos = FactoryGirl.create :usuario_dos
    ...
    context "usuario no autenticado" do
      it "no  permite actualizar el negocio y devuelve un mensaje de error" do
    ...
    context "usuario no administrador autenticado dueño" do
      it "permite actualizar el negocio" do
        # Login usuario_uno
        @cabeceras_peticion.merge! @usuario_uno.create_new_auth_token
